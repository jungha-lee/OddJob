...
VALUES ('pam@be.com', '$2a$11$Z7P4Kczw5qARQ4J/qX/bTuOlpjTDm2/lh7pDgRwYSO3CGFNc8hoxW', 'Pamela', 'Anderson', '07245514', 'Working a lot so do not have time for chores'),
('moneypenny@mit.co.uk', '$2a$11$Z7P4Kczw5qARQ4J/qX/bTuOlpjTDm2/lh7pDgRwYSO3CGFNc8hoxW', 'Money', 'Penny', '+44 0123 23 32', 'Classified'),
('Michelle@casablanca.org', '$2a$11$Z7P4Kczw5qARQ4J/qX/bTuOlpjTDm2/lh7pDgRwYSO3CGFNc8hoxW', 'Michelle', 'Obama', '072-454 43 43', 'Got used to white house staff helping us but now we only use OddJob!'),
('linus@academy.se', '$2a$11$Z7P4Kczw5qARQ4J/qX/bTuOlpjTDm2/lh7pDgRwYSO3CGFNc8hoxW', 'Linus', 'Eriksson', '0721902254', 'Bom dia!'),
('jungha@academy.se', '$2a$11$Z7P4Kczw5qARQ4J/qX/bTuOlpjTDm2/lh7pDgRwYSO3CGFNc8hoxW', 'Jungha', 'Lee', '0724551334', 'Can help you move with my huge van'),
('ana@gmail.com', '$2a$11$Z7P4Kczw5qARQ4J/qX/bTuOlpjTDm2/lh7pDgRwYSO3CGFNc8hoxW', 'Anatoli', 'Vahterov', '070-33 66 712', 'I help you with this shit'),
('daniel@academy.se', '$2a$11$Z7P4Kczw5qARQ4J/qX/bTuOlpjTDm2/lh7pDgRwYSO3CGFNc8hoxW', 'Daniel', 'Persson', '072412314', 'Certified ping pong sensei'),
('lars@telia.com', '$2a$11$Z7P4Kczw5qARQ4J/qX/bTuOlpjTDm2/lh7pDgRwYSO3CGFNc8hoxW', 'Lars', 'Hammar', '0729213', 'I am a friendly guy');
...
VALUES ('Painting', 1500, '2019-04-17', 2, 1 , 'Need to paint my daughters room pink. Bring your own paint', 'https://res.cloudinary.com/linusaxel/image/upload/v1553348357/no-image-icon-6.png'),
('Plumbing', 700, '2019-04-02', 4, 2 , 'Fix my pipes', 'https://res.cloudinary.com/linusaxel/image/upload/v1553348357/no-image-icon-6.png'),
('Gardening', 300, '2019-04-04', 1, 3 , 'Fix my plants', 'https://res.cloudinary.com/linusaxel/image/upload/v1553348357/no-image-icon-6.png'),
('Painting', 700, '2019-04-12', 2, 4 , 'Fix my wall', 'https://res.cloudinary.com/linusaxel/image/upload/v1553348357/no-image-icon-6.png'),
('Plumbing', 700, '2019-05-02', 4, 5 , 'My toilet is clogged', 'https://res.cloudinary.com/linusaxel/image/upload/v1553348357/no-image-icon-6.png'),
('Teaching', 700, '2019-04-02', 3, 1 , 'Need someone to help my kid practice math', 'https://res.cloudinary.com/linusaxel/image/upload/v1553348357/no-image-icon-6.png'),
('Technology', 100, '2019-04-01', 4, 2 , 'Install my new computer', 'https://res.cloudinary.com/linusaxel/image/upload/v1553348357/no-image-icon-6.png'),
('Painting', 1220, '2019-06-02', 5, 3 , 'My house is brown but I would like it red.', 'https://res.cloudinary.com/linusaxel/image/upload/v1553348357/no-image-icon-6.png'),
('Plumbing', 700, '2019-04-02', 6, 4 , 'Fix my pipes', 'https://res.cloudinary.com/linusaxel/image/upload/v1553348357/no-image-icon-6.png'),
('Gardening', 300, '2019-04-04', 8, 5 , 'Fix my plants', 'https://res.cloudinary.com/linusaxel/image/upload/v1553348357/no-image-icon-6.png'),
('Painting', 700, '2019-04-12', 7, 1 , 'Fix my wall', 'https://res.cloudinary.com/linusaxel/image/upload/v1553348357/no-image-icon-6.png'),
('Plumbing', 700, '2019-05-02', 4, 2 , 'My toilet is clogged', 'https://res.cloudinary.com/linusaxel/image/upload/v1553348357/no-image-icon-6.png'),
('Gardening', 200, '2019-04-01', 4, 3 , 'Mow my lawn. 200 sqm', 'https://res.cloudinary.com/linusaxel/image/upload/v1553348357/no-image-icon-6.png');
